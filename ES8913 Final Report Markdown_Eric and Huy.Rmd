...
kable_mw_tissue <- knitr::kable(tissue_MW,
             digits = 4,
             align = "c",
             caption = "Table SX: MW-test p-values for Comparisons of Contaminant Distributions in Each Tissue Type")
...
kable_mw_species <- knitr::kable(species_MW,
             digits = 4,
             align = "c",
             caption = "Table SX: MW-test p-values for Comparisons of Contaminant Distributions in Both Bird Species")
